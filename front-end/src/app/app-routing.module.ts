...
const routes: Routes = [
  ...
  {path: 'resultats-record', component: ResultatsRecordComponent, canActivate: [LoginGuard], canDeactivate : [LogoutGuard]},
  {path: 'resultats/:id', component: ResultatsComponent},
  {path: 'accueil', component: AcceuilComponent},
  {path: 'description', component: DescriptionAccueilComponent},
  {path: 'user-profil', component: UserProfileComponent, canActivate: [LoginGuard], canDeactivate : [LogoutGuard]},
  ...
  {path: 'quiz-color-list', component: QuizColorListComponent, canActivate: [LoginGuard], canDeactivate : [LogoutGuard]},
  {path: 'quiz-color-view-list', component: QuizColorViewListComponent, canActivate: [LoginGuard], canDeactivate : [LogoutGuard]},
  {path: 'lancement-quiz-color/:id', component: LancementQuizColorComponent, canActivate: [LoginGuard], canDeactivate : [LogoutGuard]},
